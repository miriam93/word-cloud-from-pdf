...
var fichasDocentes = [633,634,,635,719,720,721,722,723,724,747,749,751,765,770,776,778,780,781,788,793,
					  804,813,816,819,822,825,828,853,863];
...
for (var i in fichasDocentes)
	getWords(fichasDocentes[i]);